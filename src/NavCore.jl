...
@static if false # unfortunate hacky fix to make my lsp work properly 
  #https://discourse.julialang.org/t/lsp-missing-reference-woes/98231/15
  include("../scripts/scalar_constant.jl")
  include("../scripts/simple_integrator.jl")
  # add new scripts/tests here
end
